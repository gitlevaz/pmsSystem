...
return c};this.where=function(l){if(b.isFunction(l)){c.execute();var m=[];b.each(f,function(o,A){l(A)&&m.push(A)});return b.from(m,c.showQuery())}c._append(l);c._setCommand(this.where,null);c._resetNegate();return c};this.groupBy=function(l,m,o,A){if(!c._hasData())return null;return c._getGROUP($str_dbconnectf,l,m,o,A)};this.distinct=function(l,m){l=c.groupBy(l,m);var o=[];b.each(l,function(A,t){o.push(t.unique)});return o};this.orderBy=function(l,m,o,A){m=m===undefined||m===null?"a":b.trim(m.toString().toLowerCase());
