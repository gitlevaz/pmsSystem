    ...
    <body><div id="preloader"></div>
        ...
        <?php 
            ...
            if (isset($_POST['btn_New'])) {
                ...
                $get_rpt_owner = getALLSYSUSERDETAILSBycmbOwner($str_dbconnect,$wk_Owner);
                $report_owner = mysqli_fetch_array($get_rpt_owner)['report_owner'];
                $bool_ReadOnly = "False";
                $Save_Enable = "No";
            ...
            if (isset($_POST['btn_Save'])) {
                ...
                $wk_Owner = $_POST["cmbOwner"];
                $_SESSION["new_wk_Owner"] = $_POST["cmbOwner"];
                $get_rpt_owner = getALLSYSUSERDETAILSBycmbOwner($str_dbconnect,$wk_Owner);
                $report_owner = mysqli_fetch_array($get_rpt_owner)['report_owner'];
            ...
            if (isset($_GET['btn_Save'])) { 
                ...
                if($_POST['timepicker_start']== NULL || $_POST['timepicker_end']== NULL){
                    ...
                    echo "<script>";
                    echo "self.location='createworkflow.php'";
                    echo "</script>";
                }
                                        ...
                                        <tr>
                                            <td>                                                
                                                <table width="100%" cellpadding="0" cellspacing="8px">        
                                                        ...
                                                        <td align="left" >
                                                            <select id="cmbOwner" name="cmbOwner" class="TextBoxStyle" onchange="getWFDetails()">
                                                                <?php
                                                                    ...
                                                                    while($_myrowRes = mysqli_fetch_array($_ResultSet)) {
                                                                ?>
                                                                <option value="<?php echo $_myrowRes['EmpCode']; ?>"  <?php if ($_myrowRes['EmpCode'] == $_SESSION["new_wk_Owner"]) echo "selected=\"selected\";" ?>> <?php echo $_myrowRes['FirstName']." ".$_myrowRes['LastName'] ; ?> </option>
                                                                <?php } ?>
                                                            </select>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td style="display: none;" id="weeklydays_icon">:</td>
                                                        <td>
                                                            <table style="display: none;" width="100%" id="weeklydays" cellpadding="0" cellspacing="0">
                                                                <tr>
