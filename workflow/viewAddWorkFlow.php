...
include ("../class/workFlowUpload.php"); 
...
<!--    <script src="../ui/jquery.ui.core.js"></script>
   ...
   <!-- <script type="text/javascript" src="../js/jquery-1.3.2.min.js"></script>-->
      ...
      function startUpload(){            
            ...
            if(valdator != false){
                if (queueSize == 0) {
                    ...
                    document.forms['frm_WorkFlow'].action = "viewAddWorkFlow.php?btn_Save=btn_Save";
	...
	function OpenEditWindow(workid,logempid){
			loadPopupBox();				
			$('#EditWorkFlow').attr('src', 'Editworkflow.php?id='+workid+'&empCode='+logempid+'')
	}
</script>   
    ...
    <body><div id="preloader"></div>
        <div id="preloader">    <!-- OUR PopupBox DIV-->
            <iframe id="EditWorkFlow" width="600px"  height="475px" frameborder="0" scrolling="yes"></iframe>
        ...
        <?php
            ...
            $MailsCC[]        = ""; 
			 $logempid = "";     
			 $EmployeeGroup = "user";
			 $bool_EnableWorkflow = "FALSE";
			 
			 if(isset($_GET['logempid'])) 
            { 
                $logempid = $_GET['logempid'];    
				$_SelectQuery   =  "SELECT UserGroup FROM tbl_sysusers WHERE `EmpCode` = '$logempid' AND `UserStat` = 'A'" or die(mysqli_error($str_dbconnect));
                $_ResultSet      =  mysqli_query($str_dbconnect,$_SelectQuery) or die(mysqli_error($str_dbconnect));

                while($_myrowRes = mysqli_fetch_array($_ResultSet)) {
                    $EmployeeGroup	=   $_myrowRes['UserGroup'];
                }
				if("USR"==$EmployeeGroup)
				{
					$bool_EnableWorkflow = "TRUE";
				}
				else {
					$bool_EnableWorkflow = "FALSE";
				}
            ...
            if (isset($_POST['btn_New'])||($logempid!="")) {
            ...
            if (isset($_POST['btn_Save'])) {
                ...
                mysqli_query($str_dbconnect,$_SelectQuery) or die(mysqli_error($str_dbconnect));
				$_LogEMPCODE12 = $logempid;       
       				header("Location: UpdateWorkFlow.php?logempid=$_LogEMPCODE12");
            }
            
            if (isset($_GET['btn_Save'])) {                
                
                $inputString = $_POST['timepicker_start'];
                preg_match('/\b[a-zA-Z]{2}\b/', $inputString, $matches);

                $_SESSION["validation"] = 0;
                if($_POST['timepicker_start']== NULL || $_POST['timepicker_end']== NULL){
                    $_SESSION["validation"] = 1;
                    echo "<script>history.back();</script>";
                }

                if (isset($matches[0])) {
                    $alphabeticString       = $matches[0];
                ...
                mysqli_query($str_dbconnect,$_SelectQuery) or die(mysqli_error($str_dbconnect));
				$_LogEMPCODE12 = $_SESSION["LogEmpCode"];      
       			//header("Location: UpdateWorkFlow.php?logempid=$_LogEMPCODE12");
                echo("<script>location.href = ' UpdateWorkFlow.php?logempid=$_LogEMPCODE12';</script>");
                                ...
                                <div id="right" >
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr style="height: 50px; background-color: #E0E0E0;">
                                            ...
                                            <td style="padding-left: 60px; font-size: 16px">
                                            <?php 
                                          
                                                if(isset($_SESSION["validation"]) && !empty($_SESSION["validation"]) && $_SESSION["validation"]==1){
                                                echo "<div class='Div-Error' id='msg' align='left'>*** Please Enter required feilds</div>";
                                                }

                                                if(isset($_SESSION["validation"]) && !empty($_SESSION["validation"]) && $_SESSION["validation"]==2){
                                                    echo "<div class='Div-Error' id='msg' align='left'>*** Alphabetic word found in time </div>";
                                                    }
                                            ?>                                   
                                            </td>  
                                            ...
                                            <td>                                                
                                                <table width="100%" cellpadding="0" cellspacing="8px">        
                                                        ...
                                                        <td align="left" >
                                                            <select id="cmbOwner" name="cmbOwner" class="TextBoxStyle" onchange="getWFDetails()">
                                                                <?php
                                                                    ...
                                                                    $_ResultSet = getEMPLOYEEDETAILSName($str_dbconnect,$logempid) ;
                                                                    while($_myrowRes = mysqli_fetch_array($_ResultSet)) {
                                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <input type="text" class="TextBoxStyle" name="timepicker_start" id="timepicker_start" size="15" required value="<?php if(isset($_POST['timepicker_start'])) { echo $_POST['timepicker_start']; }?>"></input>                                                        
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left">
                                                        ...
                                                        <td align="left">
                                                            <input type="text" class="TextBoxStyle" name="timepicker_end" id="timepicker_end" size="15" required value="<?php if(isset($_POST['timepicker_end'])) { echo $_POST['timepicker_end']; }?>"></input>                            
                                                        </td>
                                                    </tr>  
													<script type="text/javascript">
								                        $(document).ready(function() {
                                                    ...
                                                    <tr>
                                                        <td colspan="3">
                                                            <div class="demo">
                                                                <br></br>
                                                                <center>                            
                                                                    <!--<input type="submit"  value="New"  id="btn_New" name="btn_New" /*<?php  /*?>if ($_SESSION["Str_NEW"] == "FALSE") echo "disabled=\"disabled\";<?php */?>" ?>*//>
                                                                    <input type="submit" value="Modify" id="btn_Modify" name="btn_Modify" <?php /*?><?php if ($_SESSION["Str_MOD"] == "FALSE") echo "disabled=\"disabled\";" ?><?php */?>/>-->
