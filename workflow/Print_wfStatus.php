 ...
 */
    ...
    $_Title     =   "W/F - Status Summary Report as at ".$Dte_today." : ".$Dte_Time.".";
    $_SubTitle  =   "Div. - ".$_Division." / Dpt. - ".$_DepartCode." / W/F Owner - ".$FilEmpName." / W/F. Sts. - ".$_TskStatus;
    ...
    if($_Division == "ALL"){
        ...
        $_DivisionCMD = " AND t2.report_div = '$_Division' ";
    }
    
    if($_DepartCode == "ALL"){
        $_DepartCodeCMD = "";
    }else{
        $_DepartCodeCMD = " AND t2.report_Dept = '$_DepartCode' ";
    }
    ...
    $_SelectQuery   =   "SELECT t1.wk_id, t1.wk_owner, t1.wk_name, t1.start_time, t1.end_time, t1.wk_update, t1.crt_date, t1.status, t2.report_div, t2.report_Dept 
                            FROM tbl_workflowupdate  AS t1 INNER JOIN tbl_workflow as t2 ON t1.wk_id = t2.wk_id 
                                WHERE  t1.crt_date >= '".$_StartDate."' AND t1.crt_date <= '".$_EndDate."' ".$_TskStatusCMD."".$_DivisionCMD."".$_DepartCodeCMD."".$_EMPCodeCMD." 
                                    GROUP BY t1.crt_date, t2.report_div, t2.report_Dept, t1.wk_owner, t1.wk_id, t1.wk_name, t1.start_time, t1.end_time, t1.wk_update, t1.status 
    ...
    while($_myrowRes = mysqli_fetch_array($_ResultSet)) {    
        ...
        $NewDivition = $_myrowRes['report_div'];
        
                
        $OldDepartment = $Newdepartment;
        $Newdepartment = $_myrowRes['report_Dept'];
        ...
        if($OldDivition != ""){
            ...
            if($OldDate != $NewDate){  
                ...
                $MailBody .= "<th colspan=\"3\" align=\"left\">";
                    ...
                    $MailBody .= "<b>W/F Divition : </b>".$NewDivition." | ";
                    $MailBody .= "<b>W/F Department : </b>".getGROUPNAME($str_dbconnect,$Newdepartment)." | ";
        ...
        $MailBody .= "</tr>";
        $MailBody .= "<tr>";
        $MailBody .= "<td width=\"10%\"><b>Workflow Attachments By Creator</b></td>";
        $MailBody .= "<td colspan=\"2\" align=\"left\" width='90%'>";  
                    ...
                    if($num_rows > 0){                            
                        ...
                        $MailBody .= "There are no Workflow Attachments to Download";
                    }

        $MailBody .= "</td>";                         
        $MailBody .= "</tr>"; 
		$MailBody .= "<tr>";
        $MailBody .= "<td width=\"10%\"><b>Workflow Attachments By User / Supervisor</b></td>";
        $MailBody .= "<td colspan=\"2\" align=\"left\" width='90%'>";  
                    ...
                    if($num_rows > 0){                            
                        ...
                        $MailBody .= "There are no Updated Workflow Attachments to Download";
                    }
