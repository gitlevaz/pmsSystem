   ...
   // echo  json_encode($row2);
      ...
      {	
	   ...
	   //
			...
			$query4 = "UPDATE prodocumets SET ParaCode = '$TaskCode', FileName = 'TSK' WHERE procode = '$TaskCode'";
