...
$connection = include_once('../connection/mobilesqlconnection.php');
  include ("../class/accesscontrole.php"); 
    ...
    $EmpCode = $_GET["EmpCode"];
	 ...
	 $urlEmpCode= str_replace("/","-",$EmpCode);
	 $url="#,workflow,".$urlEmpCode."";
	 
	 	 
$InsertFirstTime ="INSERT INTO tbl_PushNotificationMessage(EmpCode,Message,Category,Title,Url) VALUES ('$EmpCode', '$Message','New Workflow Notification','$Title','$url')";               
			$result1=mysqli_query($link,$InsertFirstTime) or die(mysqli_error($link));
			
			
//Send notification to device part comes here			
