...
$totIncompPrstg = 0;
        ...
        $HTML .= "</head>";
        $HTML .= "<body>";		
		$HTML .= "<h3 align=\"center\" style=\"font-family:calibri;\">CHN-Workflow: Weekly status of workflow from $showFriday_date to $showThursday_date</h3>";
        ...
        $departmentSql = "SELECT `GrpCode`, `Group` FROM `tbl_projectgroups` WHERE Country = 'CHN' ORDER BY `Group` ASC";
