...
$totIncompPrstg = 0;
        ...
        $HTML .= "</head>";
        $HTML .= "<body>";		
		$HTML .= "<h3 align=\"center\" style=\"font-family:calibri;\">US-Workflow: Weekly status of workflow from $showFriday_date to $showThursday_date</h3>";
