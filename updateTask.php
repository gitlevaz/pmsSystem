...
//                echo "<div class='Div-Msg' id='msg' align='left'>*** Project Updated Successfully</div>";
    ...
    <div id="container">
            ...
            <form name="frm_porject" id="frm_porject" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" class="cmxform">
                ...
                <legend ><strong>Update Task Details</strong></legend>

                    <p>
                        <label for="txtProCode">Project Code</label>
                        <input type="text" id="txtProCode" name="txtProCode" class="required ui-widget-content" size="20" value="<?php echo $Str_ProCode; ?>" readonly="readonly"/>
                    </p>

                    <p>
                        <label for="txtProName">Project Name</label>
                        <input type="text" id="txtProName" name="txtProName" class="required ui-widget-content" size="60" value="<?php echo $Str_ProName; ?>" readonly="readonly"/>
                     </p>

                    <p>
                        <label for="txtTaskCode">Task Code</label>
                        <input type="text" id="txtTaskCode" name="txtTaskCode" class="required ui-widget-content" size="20" value="<?php echo $Str_TaskCode; ?>" readonly="readonly"/>
                    </p>

                    <p>
                        <label for="txtTaskName">Task Name</label>
                        <input type="text" id="txtTaskName" name="txtTaskName" class="required ui-widget-content" size="60" value="<?php echo $Str_TaskName; ?>" readonly="readonly"/>
                    </p>

                    <p>
                        <label>Category</label>
                        <select id="optPriority" name="optPriority" class="required ui-widget-content" <?php if($bool_ReadOnly == "TRUE") echo "disabled=\"disabled\";" ?>>
                            <?php
                            $IneerCount =   0;
                    ...
                    <p>
                        ...
                        <input type="hidden" id="hidden" name="hidden" class="required ui-widget-content" value="<?php echo $Precentage; ?>" size="10" readonly="readonly"/>
                    </p>

                    <div class="slider" style="top: -23px; left: 220px; width: 200px"></div>
                    ...
                    <p>
                        <label for="txtTaskDescription">Update Details</label>
                    ...
                    <p>
                        <label>Update Latest Hours Spent</label>
                        <label style="width: 50px">From :</label>
                        <input type="text" name="txtStart" id="txtStart"  class="required ui-widget-content" value="00:00" size="9" onchange="getTimeDiff()" <?php if($bool_ReadOnly == "TRUE") echo "readonly=\"readonly\";" ?> align="center"/>
                        <script type="text/javascript">
                            $('#txtStart').timepicker({
                                timeFormat: 'h:m',
                                separator: ' @ '
                        ...
                        <input type="text" name="txtEnd" id="txtEnd"  class="required ui-widget-content" value="00:00" size="9" onchange="getTimeDiff()" <?php if($bool_ReadOnly == "TRUE") echo "readonly=\"readonly\";" ?> align="center"/>
                        <script type="text/javascript">
                            $('#txtEnd').timepicker({
                                timeFormat: 'h:m',
                                separator: ' @ '
                        ...
                        <label style="width: 60px; text-align: center; color: #CC0000;" >&nbsp;<font size="2px"><b> < OR > </b></font></label>
                        <label style="width: 150px">Total Hours Spent : </label>
                        <input type="text" id="txtHoursSpent" name="txtHoursSpent" class="required ui-widget-content" size="9" value="<?php echo $Str_txtHoursSpent; ?>" <?php if($bool_ReadOnly == "TRUE") echo "readonly=\"readonly\";" ?> align="center"/>
                    </p>

                </fieldset>

                <fieldset class="ui-widget ui-widget-content ui-corner-all" style="padding-left: 340px; padding-top: 10px; padding-bottom: 10px;" >
                    <input name="btnSave" id="btnSave1" type="button" value="Save All Updates" <?php if($Save_Enable == "No") echo "disabled=\"disabled\";" ?> onclick="startUpload()" style="width: 100px"/>
                    <input name="btnCancel" id="btnCancel1" type="reset"  value="Cancel" style="width: 60px"/>
                </fieldset>

                <fieldset class="ui-widget ui-widget-content ui-corner-all" style="padding-left: 10px;">
                <legend><strong>Current Hours Summary</strong></legend>

                    <p>
                        <label>Hrs Estimated : </label>
                        <input type="text" name="txtHrsEstimated" id="txtHrsEstimated" class="required ui-widget-content" value="<?php echo $EstimatedHours; ?>" size="9" readonly="readonly" align="center"/>
                        <label style="width: 50px">&nbsp;</label>
                        <label>Addl Hrs Requested : </label>
                        <input type="text" name="txtHrsRequested" id="txtHrsRequested"  class="required ui-widget-content" value="<?php echo $AddlHrsRequest; ?>" size="9" onchange="getTimeDiff()" readonly="readonly" align="center"/>
                    </p>

                    <p>
                        <label>Addl Hrs Approved : </label>
                        <input type="text" id="txtHrsApproved" name="txtHrsApproved" class="required ui-widget-content" size="9" value="<?php echo $AddlHrsApproved; ?>" readonly="readonly" align="center"/>
                        <label style="width: 50px">&nbsp;</label>
                        <label>Hrs Remaining : </label>
                        <input type="text" id="txtHrsRemaining" name="txtHrsRemaining" class="required ui-widget-content" size="9" value="" readonly="readonly" align="center"/>
                    ...
                    <p>
                        <label style="color: #cd0a0a;">Request Additional Hours</label>
                        <input type="text" name="txtHrsRequest" id="txtHrsRequest" class="required ui-widget-content" value="00:00" size="9" onchange="getTimeDiff()" readonly="readonly" align="center"/>
                        <script type="text/javascript">
                ...
                <fieldset class="ui-widget ui-widget-content ui-corner-all" style="padding-left: 10px;">
                <legend><strong>Download Task Support Documents</strong></legend>
...
<!--                           <a href="files/<?php echo $_myrowRes['SystemName'] ; ?>"><?php echo $_myrowRes['SystemName'] ; ?></a><br>-->
                                <a href="files/<?php echo $_myrowRes['SystemName'] ; ?>"><?php echo $_myrowRes['SystemName'] ; ?></a> | <font color="red"><a style="color: Red" href="updateTask.php?taskcode=<?php echo $Str_TaskCode?>&DocCode=<?php echo $_myrowRes['ProCode'] ; ?>">Remove</a></font><br>
                        <?php }
                            if($ItemCount == 0) {
                ...
                <fieldset class="ui-widget ui-widget-content ui-corner-all" style="padding-left: 10px;">
                <legend><strong>TASK Alerts Recepient List </strong></legend>
                    <p>
                    <?php
                        $ProOwnerMail       =   getSELECTEDEMPLOYEEMAIL($str_dbconnect,$_ProOwner);
                        $StrToMail          =   getSELECTEDEMPLOYEEMAIL($str_dbconnect,$_ProInit);
                ...
                <fieldset class="ui-widget ui-widget-content ui-corner-all" style="padding-left: 10px;" id="fileUpload" >
                ...
                <fieldset class="ui-widget ui-widget-content ui-corner-all" style="padding-left: 10px;" id="fileUpload" >
                <legend><strong> Upload / Download - Documents </strong></legend>
                    <p>
                        <?php
                            ...
                            //echo "<option value='".$_myrowRes['SystemName']."' ondblclick='Download(dsfsdf)'>".$_myrowRes['SystemName']."</option>";
                        ?>
<!--                                    <a href="files/<?php echo $_myrowRes['SystemName'] ; ?>"><?php echo $_myrowRes['SystemName'] ; ?></a> | <a href="files/<?php echo $_myrowRes['SystemName'] ; ?>">Remove</a><br>-->
                        <a href="files/<?php echo $_myrowRes['SystemName'] ; ?>"><?php echo $_myrowRes['SystemName'] ; ?></a> | <font color="red"><a style="color: Red" href="updateTask.php?taskcode=<?php echo $Str_TaskCode?>&DocCode=<?php echo $_myrowRes['ProCode'] ; ?>">Remove</a></font><br>
                ...
                <fieldset class="ui-widget ui-widget-content ui-corner-all" style="padding-left: 340px; padding-top: 10px; padding-bottom: 10px;" >
                    <input name="btnSave" id="btnSave" type="button" value="Save All Updates" <?php if($Save_Enable == "No") echo "disabled=\"disabled\";" ?> onclick="startUpload()" style="width: 100px"/>
                    <input name="btnCancel" id="btnCancel" type="reset"  value="Cancel" style="width: 60px"/>
                </fieldset>

                <fieldset class="ui-widget ui-widget-content ui-corner-all" style="padding-left: 10px;">
                <legend><strong> Updates Summary </strong></legend>
                    <p>
