                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr style="height: 50px; background-color: #E0E0E0;">
                                            <td style="padding-left: 10px; font-size: 16px">
                                                <font color="#0066FF"> Listed Tasks Under Project : </font><b><?php echo get_SelectedProjectName($str_dbconnect,$Str_ProCode); ?></b>                                                
                                            </td>                                            
                                        </tr>    
                                        <tr align="center">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                ...
                                                                $ColourCode = 0 ;
                                                                $LoopCount = 0;
                                                                $_ResultSet = get_userprojecttaskDetails($str_dbconnect,$Str_ProCode);
