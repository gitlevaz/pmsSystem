...
<head>
    ...
    <title>.:: PMS EMAIL ALERT GROUP DETAILS ::.</title>
    ...
    <script language="javascript" type="text/javascript">
		...
		function DeleteFac(hlink){
			...
			if (Error == "False") {
				...
				document.forms[0].action = "PMSEmailBccGroup.php?Mode=Delete&GRPCODE="+GRPCODE+"&Access="+Access+"";
		...
		function SaveFac(hlink){
			...
			if (Error == "False") {
				...
				document.forms[0].action = "PMSEmailBccGroup.php?Mode=Save&GRPCODE="+GRPCODE+"&Access="+Access+"";
				document.forms[0].submit();
			}
		...
		function ChangeTask(){
			...
			document.forms[0].action = "PMSEmailBccGroup.php?Mode=Chg&GRPCODE="+EmpCODE+"";
			document.forms[0].submit();
                                ...
                                <div id="right" >                                    
                                   <table width="98%" cellpadding="0" cellspacing="8px" align="center">
                                        <tr>
                                            <td>
												<tr>
                                                    <td ><strong>PMS Email Alert Group</strong>
                                                     <td></td>
                                                    <td></td>
                                                     <td></td>
                                                    <td ></td>
                                                    ...
                                                    <tr height="25px"></tr>
                                                    <tr>
                                                    	<td align="right">Select the PMS Owner</td>
                                                    <td>
												...
												<tr>
                                                    ...
                                                    <td></td>
                                                    <td align="center">
                                                    	<input name="Save" class="buttonView" type="button" id="Save" style="cursor: pointer" value="Save  >  " onclick="SaveFac('<?php echo $_GRPCODE; ?>');" /><br/><br/><br/>
