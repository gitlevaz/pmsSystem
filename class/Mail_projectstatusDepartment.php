 ...
 */
    ...
    while($_DeparmentRes = mysqli_fetch_array($_DeparmentSet)) {
        ...
        $_Title =   "P/M - ".strtoupper($_DeparmentRes['Country'])."(".strtoupper($_DeparmentRes['Group']).") as at ".$Dte_today." : ".$Dte_Time.".";

        $MailBody           =   "";
        $TitleEntered       =   0;
        
    $_ProjetSet = get_ActiveProjectDetailsDepartment($str_dbconnect,$_DepartCode);
