...
*/
    ...
    $_ProjetSet = get_ProjectDetailsTaskEmployeePrint($str_dbconnect,$_EMPCode, $_Division, $_DepartCode);
...
$MailBody           .= "
    <tr>
        ...
        <td align='center'>&nbsp</td>
        <td align='left'>&nbsp</td>  <!--updated from $_prostatus to $_TskStatus on 18/07/2013 -->
        <td align='center'>&nbsp</td>
        <td align='center'>&nbsp</td>        
        ...
        $_ResultSet = get_TaskDelayDetails($str_dbconnect,$Dte_today,$Str_ProjectCode, $EmpCode);
        while($_myrowRes = mysqli_fetch_array($_ResultSet))
        {
//
    ...
    ?>
    <?php
        $MailBody .= "<td colspan='15' bgcolor='#a9a9a9'>&nbsp</td>";
        }
    }
        $MailBody .= "
                    </table>
